...
Cron harian dipasang lewat `bash deploy/setup_kinerja_cron.sh [berdata|kinerja]` (idempotent): `sync_kinerja_analog` 01:10, `sync_kinerja_digital` 01:20, `sync_rc` 01:30 — semuanya `--days 3` supaya satu malam yang gagal otomatis tersusul malam berikutnya. Dini hari karena availability dihitung per batas hari penuh (00:00–24:00), jadi angka sebuah hari baru final setelah tengah malam.
