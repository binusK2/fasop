...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(model_name='maintenanceteleproteksi', name='skema_1_send_teg',
            field=models.CharField(blank=True, choices=[('48','48 V'),('110','110 V'),('220','220 V')], max_length=10, verbose_name='Skema 1 Teg Send')),
        ...
        migrations.AddField(model_name='maintenanceteleproteksi', name='skema_1_receive_teg',
            field=models.CharField(blank=True, choices=[('48','48 V'),('110','110 V'),('220','220 V')], max_length=10, verbose_name='Skema 1 Teg Receive')),
        ...
        migrations.AddField(model_name='maintenanceteleproteksi', name='skema_2_send_teg',
            field=models.CharField(blank=True, choices=[('48','48 V'),('110','110 V'),('220','220 V')], max_length=10, verbose_name='Skema 2 Teg Send')),
        ...
        migrations.AddField(model_name='maintenanceteleproteksi', name='skema_2_receive_teg',
            field=models.CharField(blank=True, choices=[('48','48 V'),('110','110 V'),('220','220 V')], max_length=10, verbose_name='Skema 2 Teg Receive')),
        ...
        migrations.AddField(model_name='maintenanceteleproteksi', name='skema_3_send_teg',
            field=models.CharField(blank=True, choices=[('48','48 V'),('110','110 V'),('220','220 V')], max_length=10, verbose_name='Skema 3 Teg Send')),
        ...
        migrations.AddField(model_name='maintenanceteleproteksi', name='skema_3_receive_teg',
            field=models.CharField(blank=True, choices=[('48','48 V'),('110','110 V'),('220','220 V')], max_length=10, verbose_name='Skema 3 Teg Receive')),
        ...
        migrations.AddField(model_name='maintenanceteleproteksi', name='skema_4_send_teg',
            field=models.CharField(blank=True, choices=[('48','48 V'),('110','110 V'),('220','220 V')], max_length=10, verbose_name='Skema 4 Teg Send')),
        ...
        migrations.AddField(model_name='maintenanceteleproteksi', name='skema_4_receive_teg',
            field=models.CharField(blank=True, choices=[('48','48 V'),('110','110 V'),('220','220 V')], max_length=10, verbose_name='Skema 4 Teg Receive')),
