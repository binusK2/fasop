...
# BELUM UPDATE
    ...
    "REPEATER": [
        ...
        {"key": "catatan_2_perangkat", "label": "Catatan Perangkat (Repeater = 2 unit radio TX + RX)", "type": "textarea",
         "placeholder": "Merk/Tipe/Serial Number utama perangkat ini mengacu ke unit Radio TX. Lengkapi identitas unit Radio RX pasangannya di field-field di bawah."},

        {"key": "merk_radio_tx",    "label": "Merk Radio TX",          "type": "text",
         "placeholder": "cth: Motorola (isi bila berbeda dari Merk utama)"},
        {"key": "tipe_radio_tx",    "label": "Tipe/Model Radio TX",    "type": "text"},
        {"key": "serial_radio_tx",  "label": "Serial Number Radio TX", "type": "text"},
        {"key": "nomor_isr_tx",     "label": "Nomor ISR Radio TX",     "type": "text",
         "placeholder": "cth: ISR-123456"},
        {"key": "frekuensi_tx",     "label": "Frekuensi TX (MHz)",     "type": "text",
         "placeholder": "cth: 455.500"},
        {"key": "tone_tx",          "label": "Tone TX",                "type": "text"},
        ...
        {"key": "merk_radio_rx",    "label": "Merk Radio RX",          "type": "text",
         "placeholder": "cth: Motorola"},
        {"key": "tipe_radio_rx",    "label": "Tipe/Model Radio RX",    "type": "text"},
        {"key": "serial_radio_rx",  "label": "Serial Number Radio RX", "type": "text"},
        {"key": "nomor_isr_rx",     "label": "Nomor ISR Radio RX",     "type": "text",
         "placeholder": "cth: ISR-123456"},
        {"key": "frekuensi_rx",     "label": "Frekuensi RX (MHz)",     "type": "text",
         "placeholder": "cth: 450.500"},
        {"key": "tone_rx",          "label": "Tone RX",                "type": "text"},
        ...
        {"key": "nomor_isr",        "label": "Nomor ISR (izin gabungan TX/RX, jika hanya ada 1)", "type": "text",
         "placeholder": "cth: ISR-123456 — isi hanya jika satu izin mencakup pasangan TX & RX"},
    ],
