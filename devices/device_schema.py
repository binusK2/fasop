...
DEVICE_SCHEMA = {
    ...
    "Radio": [
        ...
        {"key": "Antenna",          "label": "Antenna",             "type": "text"},
        {"key": "Power Supply",     "label": "Power Supply",        "type": "text"},
        {"key": "Baterai",          "label": "Baterai",              "type": "text"},
    ...
    "VoIP": [
        ...
        {"key": "power_source",     "label": "Sumber Daya",          "type": "select",
         "options": ["PoE", "Adaptor", "PoE + Adaptor"]},
        {"key": "power_supply",     "label": "Power Supply",         "type": "text"}, 
    ],

    "Multiplexer": [
        {"key": "tipe_mux",         "label": "Tipe MUX",             "type": "select",
         "options": ["PDH", "SDH", "DWDM", "CWDM", "MSPP"]},
        {"key": "kapasitas",        "label": "Kapasitas",            "type": "select",
         "options": ["E1 (2 Mbps)", "E3 (34 Mbps)", "STM-1 (155 Mbps)",
                     "STM-4 (622 Mbps)", "STM-16 (2.5 Gbps)", "STM-64 (10 Gbps)"]},
        {"key": "HS1",    "label": "HS1",        "type": "text"},
        {"key": "HS2",    "label": "HS2",        "type": "text"},
        {"key": "cpu1",    "label": "CPU 1",        "type": "text"},
        {"key": "cpu2",    "label": "CPU 2",        "type": "text"},
        {"key": "slotA",    "label": "Slot A",        "type": "select",
         "options": ["-", "E1Q", "16E1Q", "V.35", "6V.35", "SWITCH", "G.64", "E&M", "HDSL"]},
        {"key": "slotB",    "label": "Slot B",        "type": "select",
         "options": ["-", "E1Q", "16E1Q", "V.35", "6V.35", "SWITCH", "G.64", "E&M", "HDSL"],},
        {"key": "slotC",    "label": "Slot C",        "type": "select",
         "options": ["-", "E1Q", "16E1Q", "V.35", "6V.35", "SWITCH", "G.64", "E&M", "HDSL"],},
        {"key": "slotD",    "label": "Slot D",        "type": "select",
         "options": ["-", "E1Q", "16E1Q", "V.35", "6V.35", "SWITCH", "G.64", "E&M", "HDSL"],},
        {"key": "slotE",    "label": "Slot E",        "type": "select",
         "options": ["-", "E1Q", "16E1Q", "V.35", "6V.35", "SWITCH", "G.64", "E&M", "HDSL"],},
        {"key": "slotF",    "label": "Slot F",        "type": "select",
         "options": ["-", "E1Q", "16E1Q", "V.35", "6V.35", "SWITCH", "G.64", "E&M", "HDSL"],},
        {"key": "slotG",    "label": "Slot G",        "type": "select",
         "options": ["-", "E1Q", "16E1Q", "V.35", "6V.35", "SWITCH", "G.64", "E&M", "HDSL"],},
        {"key": "slotH",    "label": "Slot H",        "type": "select",
         "options": ["-", "E1Q", "16E1Q", "V.35", "6V.35", "SWITCH", "G.64", "E&M", "HDSL"],},
        {"key": "power_supply1",    "label": "Power Supply 1",        "type": "select",
         "options": ["Terpasang", "Tidak Terpasang"],},
        {"key": "power_supply2",    "label": "Power Supply 2",        "type": "select",
         "options": ["Terpasang", "Tidak Terpasang"],},
    ],
    ...
    "Catu Daya": [
        ...
        {"key": "merk_recti",         "label": "Merk Rectifier",            "type": "number"},
        {"key": "kapasitas_daya",   "label": "Kapasitas Rectifier (A)",     "type": "number"},
        {"key": "batterai",         "label": "Merk Batterai",               "type": "number"},
        {"key": "kapasitas_baterai","label": "Kapasitas Batterai",          "type": "number"},
