...
urlpatterns = [
    ...
    path('opsis/beban-trafo/', views.opsis_beban_trafo_endpoint,
         name='opsis_beban_trafo'),
    path('opsis/beban-trafo/riwayat/', views.opsis_beban_trafo_riwayat_endpoint,
         name='opsis_beban_trafo_riwayat'),
